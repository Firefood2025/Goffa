...
const RecipeGeneratorContainer = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
      <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4">Generate Recipe from Ingredients</h2>
      <p className="text-gray-600 text-sm sm:text-base mb-3 sm:mb-4">
        Let us suggest recipes based on what you have in your pantry.
      </p>
      <Button className="bg-kitchen-green hover:bg-kitchen-green/90 w-full sm:w-auto">
        Generate Recipes
      </Button>
    </div>
  );
...
const FavoriteRecipesManager = () => {
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6">
      <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4">Favorite Recipes</h2>
...
const RecipeList = ({ 
  ...
  if (loading) {
    return <div className="text-center py-6 sm:py-10">Loading recipes...</div>;
  }

  if (error) {
    return <div className="text-center py-6 sm:py-10 text-red-500">{error}</div>;
  }

  if (recipes.length === 0) {
    return <div className="text-center py-6 sm:py-10">No recipes found. Try changing your filters.</div>;
  }
